package com.joy.player.adapter;
...
import com.joy.player.activity.MainActivity;
import com.joy.player.proxy.utils.Constants;
import com.joy.player.widget.LvMenuItem;
...
public class MenuItemAdapter extends BaseAdapter {
    ...
    public MenuItemAdapter(Context context) {
        ...
        SharedPreferences loginInfo = mContext.getSharedPreferences(Constants.SP_LOGININFO, Context.MODE_PRIVATE);
        //如果登录了
        username = loginInfo.getString(Constants.SP_USERNAME, "admin");
    }

    private List<LvMenuItem> mItems = new ArrayList<LvMenuItem>(
            Arrays.asList(
                    //0107 屏蔽弹出栏的东西
                    new LvMenuItem(R.mipmap.topmenu_icn_night, "admin"),
