...
public class TintManager {
    ...
    public static void tintViewBackground(View view, MusicUtils.TintInfo tint) {
        Drawable background;
    ...
    public static void tintViewDrawable(View view, Drawable drawable, MusicUtils.TintInfo tint) {
