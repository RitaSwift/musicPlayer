...
import com.joy.player.MediaAidlInterface;
import com.joy.player.R;
import com.joy.player.activity.LockActivity;
import com.joy.player.downmusic.Down;
import com.joy.player.info.MusicInfo;
import com.joy.player.json.MusicFileDownInfo;
import com.joy.player.net.BMA;
import com.joy.player.net.HttpUtil;
import com.joy.player.permissions.Nammu;
import com.joy.player.provider.MusicPlaybackState;
import com.joy.player.provider.RecentStore;
import com.joy.player.proxy.utils.MediaPlayerProxy;
import com.joy.player.receiver.MediaButtonIntentReceiver;
...
public class MediaService extends Service {
    public static final String PLAYSTATE_CHANGED = "com.joy.player.playstatechanged";
    public static final String POSITION_CHANGED = "com.joy.player.positionchanged";
    public static final String META_CHANGED = "com.joy.player.metachanged";
    public static final String PLAYLIST_ITEM_MOVED = "com.joy.player.mmoved";
    public static final String QUEUE_CHANGED = "com.joy.player.queuechanged";
    public static final String PLAYLIST_CHANGED = "com.joy.player.playlistchanged";
    public static final String REPEATMODE_CHANGED = "com.joy.player.repeatmodechanged";
    public static final String SHUFFLEMODE_CHANGED = "com.joy.player.shufflemodechanged";
    public static final String TRACK_ERROR = "com.joy.player.trackerror";
    public static final String TIMBER_PACKAGE_NAME = "com.joy.player";
    public static final String MUSIC_PACKAGE_NAME = "com.android.music";
    public static final String SERVICECMD = "com.joy.player.music.servicecommand";
    public static final String TOGGLEPAUSE_ACTION = "com.joy.player.togglepause";
    public static final String PAUSE_ACTION = "com.joy.player.pause";
    public static final String STOP_ACTION = "com.joy.player.stop";
    public static final String PREVIOUS_ACTION = "com.joy.player.previous";
    public static final String PREVIOUS_FORCE_ACTION = "com.joy.player.previous.force";
    public static final String NEXT_ACTION = "com.joy.player.next";
    public static final String MUSIC_CHANGED = "com.joy.player.change_music";
    public static final String REPEAT_ACTION = "com.joy.player.repeat";
    public static final String SHUFFLE_ACTION = "com.joy.player.shuffle";
    public static final String FROM_MEDIA_BUTTON = "frommediabutton";
    public static final String REFRESH = "com.joy.player.refresh";
    public static final String LRC_UPDATED = "com.joy.player.updatelrc";
    public static final String UPDATE_LOCKSCREEN = "com.joy.player.updatelockscreen";
    ...
    public static final String TRACK_PREPARED = "com.joy.player.prepared";
    public static final String TRY_GET_TRACKINFO = "com.joy.player.gettrackinfo";
    public static final String BUFFER_UP = "com.joy.player.bufferup";
    public static final String LOCK_SCREEN = "com.joy.player.lock";
    public static final String SEND_PROGRESS = "com.joy.player.progress";
    public static final String MUSIC_LODING = "com.joy.player.loading";
    private static final String SHUTDOWN = "com.joy.player.shutdown";
    public static final String SETQUEUE = "com.joy.player.setqueue";
    ...
    public static final String LRC_PATH = "/player/lrc/";
    ...
    private void setUpMediaSession() {
        mSession = new MediaSession(this, "player");
...
//        }
        ...
        if (what.equals(META_CHANGED)) {
            ...
            Intent intent1 = new Intent("com.joy.player.emptyplaylist");
...
//                new Intent(this.getApplicationContext(), PlayingActivity.class), PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        //nowPlayingIntent.setAction("com.joy.player.LAUNCH_NOW_PLAYING_ACTION");
        nowPlayingIntent.setComponent(new ComponentName("com.joy.player","com.joy.player.activity.PlayingActivity"));
