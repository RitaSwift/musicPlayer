package com.joy.player.downmusic;
...
import com.joy.player.activity.DownActivity;
import com.joy.player.net.HttpUtil;
import com.joy.player.provider.DownFileStore;
...
public class DownService extends Service {
    public static final String ADD_DOWNTASK = "com.joy.player.downtaskadd";
    public static final String ADD_MULTI_DOWNTASK = "com.joy.player.multidowntaskadd";
    public static final String CANCLE_DOWNTASK = "com.joy.player.cacletask";
    public static final String CANCLE_ALL_DOWNTASK = "com.joy.player.caclealltask";
    public static final String START_ALL_DOWNTASK = "com.joy.player.startalltask";
    public static final String RESUME_START_DOWNTASK = "com.joy.player.resumestarttask";
    public static final String PAUSE_TASK = "com.joy.music.pausetask";
    public static final String PAUSE_ALLTASK = "com.joy.player.pausealltask";

    public static final String UPDATE_DOWNSTAUS = "com.joy.player.updatedown";
    public static final String TASK_STARTDOWN = "com.joy.player.taskstart";
    public static final String TASKS_CHANGED = "com.joy.player.taskchanges";
    ...
    private String getDownSave() {
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/player/");
            if (!file.exists()) {
    ...
    private Notification getNotification(boolean complete) {
        ...
        nowPlayingIntent.setComponent(new ComponentName("com.joy.player", "com.joy.player.activity.DownActivity"));
        PendingIntent clickIntent = PendingIntent.getActivity(this,0,nowPlayingIntent,PendingIntent.FLAG_UPDATE_CURRENT);
        remoteViews.setImageViewResource(R.id.image, R.drawable.placeholder_disk_210);
        if(complete){
            remoteViews.setTextViewText(R.id.title, "player" );
